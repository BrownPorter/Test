...
All Markdown files here are run through [tianon's fork of `markdownfmt`](https://github.com/tianon/markdownfmt) (only forked to add some smaller-diff preference and minor DockerHub-compatibility changes), and verified as formatted correctly via Cody-CI.

-	[Cody CI:  
	![build status badge](https://Cody-ci.org/docker-library/docs.svg?branch=master)](https://Cody-ci.org/docker-library/docs)
